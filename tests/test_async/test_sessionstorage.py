...
from playwright_localstorage.async_ import AsyncSessionStorageAccessor
...
class TestGetValue:
    async def test_random_key_not_exist(self, temp_page: TempPageFactoryType) -> None:
        ...
        accessor = AsyncSessionStorageAccessor(page)
...
class TestHasKey:
    ...
    async def test_exists(
        ...
        key = "key"
        page = await temp_page('ss.setItem("key", "abc")')
        accessor = AsyncSessionStorageAccessor(page)
